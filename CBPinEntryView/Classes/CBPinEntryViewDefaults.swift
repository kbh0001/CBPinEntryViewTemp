...
struct CBPinEntryViewDefaults {
    ...
    static let entryBorderWidth: CGFloat = 3.5
    ...
    static let entryBorderColour: UIColor = UIColor.white
    ...
    // Default spacing of entry fields
    static let entrySpacing: CGFloat = 47/3
    
    // Default text colour for the entry label
    static let entryTextColour: UIColor = UIColor.black

    // Default font for entry fields
    static let entryFont: UIFont = UIFont.systemFont(ofSize: 22)
